    ...
    return (
        <div className="max-w-[1200px] mx-auto font-poppins mb-28">
            ...
            <div className="grid grid-cols-3 gap-8 my-14">
                {allImages.map((img) => (
                    <div key={img.id} className="max-w-xs w-full group relative overflow-hidden rounded-md shadow-xl cursor-pointer">
                        {/* Background Image */}
                        <div
                            className={cn(
...
const allImages = [
    ...
    { id: 3, image: 'https://i.ibb.co.com/C8Nmpc0/31051600-grocery-shop-2-1.png' },
    { id: 4, image: 'https://i.ibb.co.com/6Z4T2kb/31051600-grocery-shop-2-2.png' },
    { id: 5, image: 'https://i.ibb.co.com/X2QML5t/31051600-grocery-shop-2-3.png' },
    { id: 6, image: 'https://i.ibb.co.com/ByHhHx0/31051600-grocery-shop-2-4.png' },
];
