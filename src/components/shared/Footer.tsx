      ...
      <div className="px-3 pt-[90px] pb-[10px]">
        ...
        <div className="max-w-[1400px] mx-auto  flex flex-col md:flex-row justify-between items-center">
          ...
          <ul className="flex flex-wrap items-center justify-center space-x-6 text-white">
            ...
            <li><Link to="/" className="hover:text-green">Services</Link></li>
            <li><Link to="/portfolio" className="hover:text-green">Portfolio</Link></li>
            <li><Link to="/" className="hover:text-green">About</Link></li>
            <li><Link to="/" className="hover:text-green">Our Team</Link></li>
