...
const Banner = () => {
    return (
        <div id="#home" className="relative bg-gradient-to-r from-gray-500 to-gray-700 text-white py-20 px-8 h-[550px] md:h-[600px] lg:h-[650px] flex flex-col items-center justify-center">
            <div>
                {/* Background Video */}
                ...
                <div className="relative z-10 max-w-[1400px] text-center mx-auto">
                    <div>
                        <h3 className="uppercase tracking-[12px] text-2xl font-semibold mb-6   ">welcome to</h3>
                        ...
                        <p className="text-xl md:text-2xl font-bold mb-11">
                            <span className="text-green">Web & App  Design & Development</span> ,<span className="text-[#1DF1D3]">UI/UX Design</span> & <span className="text-[#FF8136]">Branding</span>
                        </p>
                        <Link to='./contact' className="bg-primary uppercase   hover:bg-lime-500 hover:bg-opacity-90 transition transform hover:scale-105  text-white hover:primary-light font-medium py-5 px-12 rounded-full">
                            Get Started
                        </Link>
                    </div>
                </div>
