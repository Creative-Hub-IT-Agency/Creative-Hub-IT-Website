    ...
    return (
        <div className="bg-[#131415] px-5">
            ...
            <div className="text-center text-white pt-[75px] mb-[85px]">
                <p className="text-[40px] text-center text-white font-bold mb-5">Contact <span className="text-[#9FDC49]">Us</span></p>
                <p className="text-lg font-medium">Any question or remarks? Just write us a message!</p>
            </div>
            ...
            <div className="flex flex-col md:flex-row bg-[#363738] gap-5 lg:gap-[100px] p-6 lg:p-8 mb-5 max-w-[1400px] mx-auto rounded-xl ">
                ...
                <div className="w-full md:w-1/2 bg-[#00000033] md:max-w-[500px] rounded-md p-5 relative">
                    <div className="mb-[86px]">
                        ...
                        <p className="text-text text-lg font-normal">Say something to start a live chat!</p>
                    </div>
                ...
                <div className="w-full md:w-1/2 flex-1">
                    ...
                    <form ref={form} onSubmit={sendEmail} className="flex flex-col p-2" action="">
                        <div className="flex flex-col md:flex-row  md:gap-[80px] flex-1 md:mb-[45px]">
                            <div className="flex flex-col justify-start mb-5 w-full md:w-1/2">
                                <label className="w-20 inline-block text-white text-left mr-4">First Name</label>
                                <input
                                    type="text"
                                    name="name"
                                    id="name"
                            ...
                            <div className="flex flex-col justify-start mb-5 w-full md:w-1/2">
                                <label className="w-20 inline-block text-white text-left mr-4">Last Name</label>
                                <input
                                    type="text"
                                    name="name"
                                    id="name"
                        ...
                        <div className="flex flex-col md:flex-row md:gap-[80px] flex-1 md:mb-[50px]">
                            <div className="flex flex-col justify-start mb-5 w-full md:w-1/2">
                                <label className="w-20 inline-block text-white text-left mr-4">Email</label>
                                <input
                                    type="email"
                                    name="email"
                                    id="email"
                            ...
                            <div className="flex flex-col justify-start mb-5 w-full md:w-1/2">
                                <label className="w-20 inline-block text-white text-left whitespace-nowrap mr-4">Phone Number</label>
                                <input
                                    type="number"
                                    name="phone"
                                    id="phone"
                        ...
                        <div className="md:mb-[20px]">
                            <div className="flex flex-col justify-start mb-5 w-full">
                                <label className="w-20 inline-block text-white text-left mr-4">Message</label>

                                <textarea name="message" id="message" className="border-b-2 border-white flex-1 py-2 outline-none focus:border-green-400 bg-transparent text-white w-full" rows={3}  required></textarea>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end items-center relative">
                            <button
                                type="submit"
                                className="bg-primary text-xl hover:bg-lime-500 hover:bg-opacity-90  text-white py-3 mb-5 px-6 rounded-md hover:bg-green-400 transition focus:outline-none"
                            >
                                Send Message
                            </button>
                            ...
                            <div className="absolute hidden md:block mt-36 right-12">
                                <img className="h-[80px] w-[170px] object-cover" src={snackArrow} alt="phone" />
                            </div>
                        </div>
                    </form>
